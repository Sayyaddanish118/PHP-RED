...
let UserUpdateAll=async(UserUpdate)=>{
    ...
    let user_email=UserUpdate[3]
    let user_profile_pic=UserUpdate[4]
    let user_id=UserUpdate[5]
    let UserUpdateQuery="UPDATE public.tsb_user SET user_name=$1,user_last_name=$2,user_mobile=$3,user_email=$4,user_profile_pic=$5 WHERE user_id=$6"
    let UserUpdateResult=await client['master'].query(UserUpdateQuery,[user_name,user_last_name,user_mobile,user_email,user_profile_pic,user_id])
...
let MasterUserUpdateAll=async(MasterUserUpdate)=>{
    ...
    let user_email=MasterUserUpdate[3]
    let user_profile_pic=MasterUserUpdate[4]
    let user_id=MasterUserUpdate[5]
    let MasterUserUpdateQuery="UPDATE public.master_user SET user_name=$1,user_last_name=$2,user_mobile=$3,user_email=$4,user_profile_pic=$5 WHERE user_id=$6"
    let MasterUserUpdateResult=await client['master'].query(MasterUserUpdateQuery,[user_name,user_last_name,user_mobile,user_profile_pic,user_email,user_id])
...
let UserUpdateAllExceptImage=async(UserUpdate)=>{
    ...
    let UserUpdateQuery="UPDATE public.tsb_user SET user_name=$1,user_last_name=$2,user_mobile=$3,user_email=$4 WHERE user_id=$5"
    let UserUpdateResult=await client['master'].query(UserUpdateQuery,[user_name,user_last_name,user_mobile,user_email,user_id])
        return UserUpdateResult
}
...
let MasterUserUpdateAllExceptImage=async(MasterUserUpdate)=>{
    ...
    let MasterUserUpdateQuery="UPDATE public.master_user SET user_name=$1,user_last_name=$2,user_mobile=$3,user_email=$4 WHERE user_id=$5"
    let MasterUserUpdateResult=await client['master'].query(MasterUserUpdateQuery,[user_name,user_last_name,user_mobile,user_email,user_id])
        return MasterUserUpdateResult
}
