...
const listLogoController = require('../Controller/listLogoController');
...
let getUserById =async (customer_id) => {
    ...
    let customerResult = client['master'].query(customerQuery, [customer_id])
...
let rval = async () => {
 var rvalData = " SELECT logo_logo,logo_map_logo,logo_map_bus FROM public.tsb_logo "
